#include <vapaee/token/tables/_aux.hpp>
        ...
        typedef eosio::multi_index< "blockhist2"_n, blockhist2_table,
            indexed_by<"hour"_n, const_mem_fun<blockhist2_table, uint64_t, &blockhist2_table::by_hour_key>>
        > blockhist2;
        // ------------------------------------
