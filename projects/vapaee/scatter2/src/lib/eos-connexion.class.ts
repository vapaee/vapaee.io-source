...
export class EOSNetworkConnexion implements VapaeeScatterConnexion { 
    ...
    updateAccountData() {
        ...
        console.error("EOSNetworkConnexion.updateAccountData() NOT IMPLEMENTED");
    ...
    calculateTotalBalance(account:Account): Asset {
        console.error("EOSNetworkConnexion.calculateTotalBalance() NOT IMPLEMENTED");
        return null;
    }
    calculateTotalStaked(account:Account): Asset {
        console.error("EOSNetworkConnexion.calculateTotalStaked() NOT IMPLEMENTED");
        return null;
    }
    calculateResourceLimit(limit:Limit): Limit {
        console.error("EOSNetworkConnexion.calculateResourceLimit() NOT IMPLEMENTED");
        return limit;
    }
    queryAccountData(name:string): Promise<AccountData> {
        console.error("EOSNetworkConnexion.queryAccountData() NOT IMPLEMENTED");
    ...
    isNative(thing: Asset | Token): boolean {
        console.error("EOSNetworkConnexion.isNative() NOT IMPLEMENTED");
        return false;
    }
}